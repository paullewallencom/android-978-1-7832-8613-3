...
+ 	"}";
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		aTexCoordLocation = texProgram.getTexCoordLocation();
		aNormalLocation = texProgram.getNormalAttribLocation();
		aPositionLocation = texProgram.getPositionAttribLocation();
		...
		glVertexAttribPointer(aTexCoordLocation, 2, GL_FLOAT, false, stride, vertexData);
...
//		glDrawArrays(GL_TRIANGLES, 0, 6);
		explosion.render(p.getWVPTrans());
	}
