...
public class OpenGLActivity extends Activity implements SensorEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Check if OpenGL ES 2 is supported
		...
		// If it is supported, set the renderer
		if(supportsEs2) {
		...
		// Get the extra lives that have been purchased
	...
	protected void onPause() {
		super.onPause();
		if(rendererSet) {
			// Pause the surface view and the accelerometer
	...
	protected void onResume() {
		super.onResume();
		// Resume the surface view and accelerometer
		if(rendererSet) {
